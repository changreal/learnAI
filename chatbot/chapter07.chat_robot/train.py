...
from data_utils import BASE_DATA_DIR, BASE_MODEL_DIR
...
def test(params):
    ...
    x_data, y_data = pickle.load(open(BASE_DATA_DIR + 'chatbot.pkl', 'rb'))
    ws = pickle.load(open(BASE_DATA_DIR + 'wx.pkl', 'rb'))
    ...
    save_path = BASE_MODEL_DIR + 's2ss_chatbot.ckpt'
